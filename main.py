...
COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ["📢 𝐔ᴩᴅᴀᴛᴇꜱ 𝐂ʜᴀɴɴᴇʟ"],
    ["📤 𝐔ᴩʟᴏᴀᴅ 𝐅ɪʟᴇ", "📁 𝐌ʏ 𝐅ɪʟᴇꜱ"],
    ["⚡ 𝐁ᴏᴛ 𝐒ᴩᴇᴇᴅ", "📊 𝐒ᴛᴀᴛᴜꜱ"],
    ["📦 𝐏ᴋɢ 𝐈ɴꜱᴛᴀʟʟ", "🤖 𝐀ɪ 𝐀ɢᴇɴᴛ"],
    ["📞 𝐂ᴏɴᴛᴀᴄᴛ 𝐎ᴡɴᴇʀ"]
]
ADMIN_COMMAND_BUTTONS_LAYOUT_USER_SPEC = [
    ...
    ["⚡ 𝐁ᴏᴛ 𝐒ᴩᴇᴇᴅ", "📊 𝐒ᴛᴀᴛᴜꜱ"],
    ["🔄 𝐑ᴇᴀᴛᴀʀᴛ", "⏹ 𝐒ᴛᴏᴩ"],
    ["💳 𝐒ᴜʙꜱᴄʀɪᴩᴛɪᴏɴꜱ", "📢 𝐁ʀᴏᴀᴅᴄᴀꜱᴛ"],
    ["🔒 𝐋ᴏᴄᴋ 𝐁ᴏᴛ", "🟢 𝐑ᴜɴɴɪɴɢ 𝐀ʟʟ 𝐂ᴏᴅᴇ"],
    ["👑 𝐀ᴅᴍɪɴ 𝐏ᴀɴᴇʟ", "📦 𝐏ᴋɢ 𝐈ɴꜱᴛᴀʟʟ"],
    ["🤖 𝐀ɪ 𝐀ɢᴇɴᴛ", "🐙 𝐆ɪᴛʜᴜʙ 𝐑ᴇᴩᴏ"],
    ["📞 𝐂ᴏɴᴛᴀᴄᴛ 𝐎ᴡɴᴇʀ"]
]
...
def create_main_menu_inline(user_id):
    markup = types.InlineKeyboardMarkup(row_width=2)
    buttons = [
        types.InlineKeyboardButton('📢 𝐔ᴩᴅᴀᴛᴇꜱ 𝐂ʜᴀɴɴᴇʟ', callback_data='updates_channel'),
        types.InlineKeyboardButton('📤 𝐔ᴩʟᴏᴀᴅ 𝐅ɪʟᴇ', callback_data='upload'),
        types.InlineKeyboardButton('📁 𝐌ʏ 𝐅ɪʟᴇꜱ', callback_data='check_files'),
        types.InlineKeyboardButton('⚡ 𝐁ᴏᴛ 𝐒ᴩᴇᴇᴅ', callback_data='speed'),
        types.InlineKeyboardButton('📦 𝐏ᴋɢ 𝐈ɴꜱᴛᴀʟʟ', callback_data='recommended_install'),
        types.InlineKeyboardButton('🤖 AI Assistant', callback_data='ai_assistant'),
        types.InlineKeyboardButton('🐙 𝐆ɪᴛʜᴜʙ 𝐑ᴇᴩᴏ', callback_data='github_deploy'),
        types.InlineKeyboardButton('📞 𝐂ᴏɴᴛᴀᴄᴛ 𝐎ᴡɴᴇʀ', url=f'https://t.me/{YOUR_USERNAME.replace("@", "")}')
    ]
    if user_id in admin_ids:
        admin_buttons = [
            types.InlineKeyboardButton('?? ??𝐮𝐛𝐬𝐜𝐫𝐢𝐩𝐭𝐢𝐨𝐧𝐬', callback_data='subscription'),
            types.InlineKeyboardButton('📊 𝐒ᴛᴀᴛᴜꜱ', callback_data='stats'),
            types.InlineKeyboardButton('🔒 𝐋ᴏᴄᴋ 𝐁ᴏᴛ' if not bot_locked else '🔓 Unlock Bot', callback_data='lock_bot' if not bot_locked else 'unlock_bot'),
            types.InlineKeyboardButton('📢 𝐁ʀᴏᴀᴅᴄᴀꜱᴛ', callback_data='broadcast'),
            types.InlineKeyboardButton('👑 𝐀ᴅᴍɪɴ 𝐏ᴀɴᴇʟ', callback_data='admin_panel'),
        ...
        markup.add(types.InlineKeyboardButton('📊 𝐒ᴛᴀᴛᴜꜱ', callback_data='stats'))
        markup.add(buttons[4], buttons[5])
        markup.add(buttons[6])
        markup.add(buttons[7])
    return markup
...
def _logic_send_welcome(message):
    ...
    current_files = get_user_file_count(user_id)
    box = (
        "Welcome Goku Hosting Bot "
       
        f"Name: {user_name}!\n"
        f"ID: {user_id}\n\n"
        f"File: {current_files}\n\n"
        "⚡ Fᴇᴀᴛᴜʀᴇꜱ:\n"
...
def _logic_updates_channel(message):
    ...
    markup = types.InlineKeyboardMarkup(row_width=1)
    markup.add(
        types.InlineKeyboardButton("Join Channel", url="https://t.me/FreeSrcS")
    )
...
BUTTON_TEXT_TO_LOGIC = {
    ...
    "📤 𝐔ᴩʟᴏᴀᴅ 𝐅ɪʟᴇ": _logic_upload_file,
    "📁 𝐌ʏ 𝐅ɪʟᴇꜱ": _logic_check_files,
    "⚡ 𝐁ᴏᴛ 𝐒ᴩᴇᴇᴅ": _logic_bot_speed,
    "📞 𝐂ᴏɴᴛᴀᴄᴛ 𝐎ᴡɴᴇʀ": _logic_contact_owner,
    "📊 𝐒ᴛᴀᴛᴜꜱ": _logic_statistics,
    "🔄 𝐑ᴇᴀᴛᴀʀᴛ": _logic_restart_my_scripts,
    "⏹ 𝐒ᴛᴏᴩ": _logic_stop_my_scripts,
    "💳 𝐒ᴜʙꜱᴄʀɪᴩᴛɪᴏɴꜱ": _logic_subscriptions_panel,
    "📢 𝐁ʀᴏᴀᴅᴄᴀꜱᴛ": _logic_broadcast_init,
    "🔒 𝐋ᴏᴄᴋ 𝐁ᴏᴛ": _logic_toggle_lock_bot,
    "🟢 𝐑ᴜɴɴɪɴɢ 𝐀ʟʟ 𝐂ᴏᴅᴇ": _logic_run_all_scripts,
    "👑 𝐀ᴅᴍɪɴ 𝐏ᴀɴᴇʟ": _logic_admin_panel,
    "📦 𝐏ᴋɢ 𝐈ɴꜱᴛᴀʟʟ": _logic_recommended_install,
    "🤖 𝐀ɪ 𝐀ɢᴇɴᴛ": _logic_ai_assistant,
    "🐙 𝐆ɪᴛʜᴜʙ 𝐑ᴇᴩᴏ": _logic_github_deploy,
}
